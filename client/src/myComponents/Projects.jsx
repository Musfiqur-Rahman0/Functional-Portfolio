...
const Projects = ({ order, project }) => {
  ...
  return order !== "reversed" ? (
    <>
      <div className="grid md:grid-cols-2 gap-3 relative items-center mt-10">
        {/* background circle  */}
        <motion.div
          variants={glowing}
          animate="glow"
          className={`hidden md:block h-full w-1/3  absolute bg-radial from-[#763CAC] to-primary blur-[80px] left-[50%]  -top-[5%]  rounded-full z-[5px] `}
        ></motion.div>
        <motion.div
          variants={fadeIn}
          initial="hidden"
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="animate"
          className={`pt-10 pl-10 bg-black rounded-xl z-10 `}
        >
    ...
    <>
      <div className="grid md:grid-cols-2 gap-8 relative items-center mt-10">
        <motion.div
          variants={glowing}
          animate="glow"
          className={`h-1/2 w-1/2 md:h-full md:w-1/3  absolute bg-radial from-[#763CAC] to-primary blur-[80px] left-0  top-[5%]  rounded-full z-[5px] `}
        ></motion.div>
        <motion.div
          variants={fadeIn}
          initial="hidden"
          whileInView="animate"
          className={`pt-10 pr-10 bg-black rounded-xl z-10 `}
        >
          <figure className="h-[400px] w-full overflow-hidden">
            <img
              src={projectImage}
