       ...
       order  !== "reversed" ? <>
         <div className='grid grid-cols-2  relative items-center mt-10'>
            ...
            <div className=''>
             ...
             <div className='z-20 my-10 relative w-[110%] p-8 rounded-lg bg-[#2B0B3A]/70 backdrop-blur-sm'><p className=''>{description.slice(0, 220) + "..."}</p></div>
        <div className="flex items-center gap-3">
            <Button onClick={()=> navigate(`/project/${id}`)} className="bg-[#693B93] cursor-pointer" >
            ...
            <div className={`pt-10 pl-10 bg-black rounded-xl z-10 `} >
                <figure className='h-[400px] w-full'>
                    <img src="/src/assets/assignment7show.netlify.app_ (1).png " alt="" className='h-full  w-full object-cover rounded-tl-xl  ' />
                </figure>
            </div>
        </div>
       </> : <>
        ...
        <div className={`pt-10 pr-10 bg-black rounded-xl z-10 `} >
                <figure className='h-[400px] w-full'>
                    <img src="/src/assets/eventio-e228a.web.app_ (1).png" alt="" className='h-full w-full object-cover rounded-tr-lg' />
                </figure>
            </div>
            <div className=''>
                <p className='text-xs'>{category}</p>
             ...
             <div className='z-20 my-10 relative w-full p-8 rounded-lg bg-[#2B0B3A]/70 backdrop-blur-sm'><p className=''>{description.slice(0, 220) + "..."}.</p></div>
