...
const ProjectCard = ({ project, reversed }) => {
  ...
  return (
    <div 
    className="mt-5 grid grid-cols-3 gap-8 border-t border-[#693B93]  bg-gradient-to-br to-[#] from-[#2C1250] backdrop-blur-sm   p-8 rounded-2xl shadow-xl shadow-slate-900/30">
      <figure
